...
class LogConfig:
    ...
    # Error monitoring
    error_notification_threshold: int = field(default_factory=lambda: int(os.getenv('ERROR_NOTIFICATION_THRESHOLD', '10')))
    ...
    enable_log_compression: bool = field(default_factory=lambda: os.getenv('ENABLE_LOG_COMPRESSION', 'false').lower() == 'true')
    ...
    enable_error_aggregation: bool = field(default_factory=lambda: os.getenv('ENABLE_ERROR_AGGREGATION', 'true').lower() == 'true')
