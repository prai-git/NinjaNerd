/* Subtopics page — mirrors legacy obs_templates/subtopics.html.
   ...
   colour — 5 per subject for grades 1-5 (7 for math) and 10 for grades 6-7, exactly as the
...
import { param, subjectLabel, isValidGrade } from './flow.js';
...
async function init(root) {
  ...
  if (!isValidGrade(grade) || !subject) { location.replace('index.html'); return; }
